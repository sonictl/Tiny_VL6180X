/**
 * @brief Tiny_VL6180X.h for replacing Adafruit_VL6180X.h 
 *          so attiny85 can work
 * 
 */

#ifndef _TINY_VL6180X_H
#define _TINY_VL6180X_H
...
public:
  ...
  // ~Adafruit_VL6180X();
  Tiny_VL6180X(uint8_t i2caddr = VL6180X_DEFAULT_I2C_ADDR);
  ~Tiny_VL6180X();
...
private:
  ...
  Tiny_I2CDevice *i2c_dev = NULL; ///< Pointer to I2C bus interface
